                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="<?php echo Yii::app()->createUrl('site/login');?>">Login</a>
                            </li>
                            <li><a href="<?php echo Yii::app()->createUrl('userdetails/signup');?>">Sign Up</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                            <img src="<?php echo Yii::app()->baseUrl."/Oleose-master/assets/img/freeze/freeze-angled2.png"?>" alt="">
                        </div>
                        <div class="platforms">
