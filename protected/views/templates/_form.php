    ...
    <div class="uk-form-row">
        <div class="uk-grid">
            <div class="uk-width-medium-1-2">
                ...
                <?php echo $form->dropDownList($model, 'output',array('XLS' => 'XLS', 'XML' => 'XML', 'PDF' => 'PDF', 'DOCX' => 'DOCX'), array('empty' => 'Select Output','disabled'=>($model->isNewRecord)?false:true)); ?>
                <?php echo $form->error($model, 'output'); ?>
            </div>
            <div class="uk-width-medium-1-2">
                <label for="Templates_t_name" class="required">Child Template Name <span class="required">*</span></label>
                <?php echo $form->textField($model, 't_name', array('size' => 60, 'maxlength' => 250, 'class' => 'md-input ','readonly'=>($model->isNewRecord)?false:true)); ?>
        ...
        <div  class="uk-grid">
            ...
            <div class="uk-width-medium-1-2">
                ...
                <?php echo $form->dropDownList($model, 'parent_id',CHtml::listData(Templates::model()->findAll(array("condition" => "parent_id = 0")), 'id', 't_name'), array('class' => 'md-input ','prompt'=>'Select Parent')); ?>
...
<script>
    $(document).ready(function () {
        ...
        $("select[name='Templates[parent_id]']").chosen();
    });
    <?php if ($model->isNewRecord) { ?>
    url = '<?php echo Yii::app()->createUrl('templates/create') ?>';
    <?php } else { ?>
    url = '<?php echo Yii::app()->createUrl('templates/update', array('id' => $_GET['id'])) ?>';
    <?php } ?>
