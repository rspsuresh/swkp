...
header("content-disposition: attachment;filename=SOFILENAME.doc");
?>
...
<table style="width: 100%">
    ...
    foreach (file($filename) as $data) {
        ...
        if ($firstTime) {
            ...
            echo '<th style="border: 1px solid black;width:35%">Excerpt</th>';
            echo '</tr>';
            $firstTime = false;
        }
        echo '<tr>';
        echo '<td style="border: 1px solid black;width:15%">' . $dos . '</td>';
        echo '<td style="border: 1px solid black;width:25%">' . $pageNo . '</td>';
