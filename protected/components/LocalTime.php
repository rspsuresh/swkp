...
class LocalTime extends CApplicationComponent
{
    ...
    */
    ...
    public function getUnixTimeStamp($dateTime)
    {
        
        $date = new DateTime($dateTime,new DateTimeZone($this->getTimezone() ));        
    ...
    public function getLocalUnixTimeStamp($dateTime)
    {
    ...
    public function toLocalUnixTimeStamp($timestamp)
    {
