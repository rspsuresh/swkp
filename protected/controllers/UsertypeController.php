...
class UsertypeController extends RController {
    /**
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['UserType'])) {
            ...
            if ($model->save()) {
                ...
                $userSql = "insert into authitem (name, type, data ) values('$model->ut_name','2','N;')";
                $connection->createCommand($userSql)->execute();
                $this->redirect(array('view', 'id' => $model->ut_refid));
            }
        }
