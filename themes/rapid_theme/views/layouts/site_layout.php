...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="pre-loader">
            <div class="load-con">
                <img src="<?php echo Yii::app()->theme->baseUrl . "/assets/img/logo.png"; ?>" class="animated fadeInDown" alt="">
                <div class="spinner">
                    <div class="bounce1"></div>
                    <div class="bounce2"></div>
                    <div class="bounce3"></div>
                ...
                <div class="tp-banner" >
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                            <!-- MAIN IMAGE -->
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/transparent.png"; ?>"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption lfl fadeout hidden-xs"
                                ...
                                <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/Slides/hand-freeze.png"; ?>" alt="">
                            </div>
                            ...
                            <div class="tp-caption lfl fadeout visible-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/iphone-freeze.png"; ?>" alt="">
                            </div>
                        ...
                        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            ...
                            <div class="tp-caption lfb fadeout hidden-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/Slides/freeze-slide2.png"; ?>" alt="">
                            </div>
                        ...
                        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            ...
                            <div class="tp-caption customin customout hidden-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/Slides/family-freeze.png"; ?>" alt="">
                            </div>
                            ...
                            <div class="tp-caption small_light_white sfb hidden-xs" data-x="left" data-y="center" data-hoffset="0" data-voffset="80" data-speed="1000" data-start="1600" data-easing="Power4.easeOut">
                                <p>Reports are always trouble, most of time we dont get what we want. <br> But Now its time to change the view in your business,<br>Our reporting tools will show you a clear line of your business.</p>
                            </div>
                        ...
                        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            ...
                            <div class="tp-caption mediumlarge_light_white sft hidden-xs" data-x="right" data-y="center" data-hoffset="0" data-voffset="0" data-speed="1000" data-start="1200" data-easing="Power4.easeOut">
                                Workflow
                            </div>
                            <div class="tp-caption small_light_white sfb hidden-xs" data-x="right" data-y="center" data-hoffset="0" data-voffset="80" data-speed="1000" data-start="1600" data-easing="Power4.easeOut">
                                <p>Dont worry about the output, because its always best in quality. <br> We have well trained people's they provide you the good service</p>
                            </div>

                            <div class="tp-caption lfl hidden-xs" data-x="right" data-y="center" data-hoffset="0" data-voffset="160" data-speed="1000" data-start="1800" data-easing="Power4.easeOut">
                                <a href="#" class="btn btn-primary inverse btn-lg">Purchase</a>
                            </div>
                        </li>
            ...
            <section id="about">
                <div class="container">
                    ...
                    <div class="section-heading scrollpoint sp-effect3">
                        ...
                        <p>Our company is US based company, We are doing knowledge process in all kind of domain, We are stands in this field in past 15 year and we are successfull in it. </p>
                    </div>                
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4" >
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/iphone-freeze.png"; ?>" class="img-responsive scrollpoint sp-effect5" alt="">
                        </div>
            ...
            <section id="screens">
                <div class="container">
                    ...
                    <div class="slider filtering scrollpoint sp-effect5" >
                        <div class="one">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/profile.jpg"; ?>" alt="">
                            <h4>Profile Page</h4>
                        </div>
                        <div class="two">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/menu.jpg"; ?>" alt="">
                            <h4>Toggel Menu</h4>
                        </div>
                        <div class="three">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/weather.jpg"; ?>" alt="">
                            <h4>Weather Forcast</h4>
                        </div>
                        <div class="one">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/signup.jpg"; ?>" alt="">
                            <h4>Sign Up</h4>
                        </div>
                        <div class="one">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/calendar.jpg"; ?>" alt="">
                            <h4>Event Calendar</h4>
                        </div>
                        <div class="two">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/options.jpg"; ?>" alt="">
                            <h4>Some Options</h4>
                        </div>
                        <div class="three">
                            <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/screens/sales.jpg"; ?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                                <img src="<?php echo Yii::app()->baseUrl . "/Oleose-master/assets/img/freeze/freeze-angled2.png"; ?>" style="transform: rotate(-22deg);" alt="">
                            </div>
                            <div class="platforms">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 contact-details scrollpoint sp-effect2">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Level 2 VLV Complex 41<br>Saidapet Chennai 600015</h4>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <a class="pull-left" href="#" >
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">
                                                <a href="mailto:support@rapidcare.net">support@rapidcare.net</a>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">044-4001 5001</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <footer>
                <div class="container">
                    <a href="#" class="scrollpoint sp-effect3">
                        <img src="<?php echo Yii::app()->theme->baseUrl . "/assets/img/logo.png"; ?>" alt="" class="logo">
                    </a>
                    <div class="social">
